...
DIFF_CHECKSUM_ERROR_DOS: str = "ERROR: Local file [%s] with diff script (%s) of the database (%s) - one or more files have DOS line breaks which may cause checksum differences"
